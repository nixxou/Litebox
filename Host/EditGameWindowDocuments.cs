...
internal sealed partial class EditGameWindow
{
    ...
    {
        // Opens per the configured Reader provider (Media/DocOpener — the same opener the pause
        // screen and the game context menu use). This window anchors the Reader's monitor.
