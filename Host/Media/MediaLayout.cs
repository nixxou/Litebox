...
internal sealed class MediaLayout
{
    ...
    // NOTE: what makes a 3D model worth showing (front required, optional Back/Spine, Box - Full branch)
    // is NOT here — those are flat globals, so they live in LiteBox.ini (Model3dRequire*/AcceptFullScan,
    // read through Model3dOptions). This file is justified by the LIST-shaped layout, not by flat knobs.
