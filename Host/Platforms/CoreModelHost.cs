// ═══════════════════════════ LB-ORACLE (Model3dLbOracle=true) ═══════════════════════════
// Dev/diagnostic comparison harness — the WHOLE FILE is oracle-only code. Nothing here runs unless the
// LiteBox.ini flag Model3dLbOracle=true (Edit Platform dual preview) or the --render-jewel oracle probe
// asks for it: EnsureInit is lazy behind the first Available touch, so a normal launch loads NO LaunchBox
// core assembly through this path. Restored from commit 8966b19^ after its removal — the home-made
// builders still drift (PS1 spine) and need the original renderer to compare against.
// ═════════════════════════════════════════════════════════════════════════════════════════
//
