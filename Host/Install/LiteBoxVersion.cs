...
internal static class LiteBoxVersion
{
    ...
    public static readonly Version ResetConfigBelow = new(0, 0, 0);
    /// <summary>Wipe LiteBox.pending.db (drop LiteBox's tables) when its schema version is below this.</summary>
    public static readonly Version ResetPendingDbBelow = new(0, 0, 0);
    ...
    public static readonly Version RefreshNativesBelow = new(0, 7, 0);
