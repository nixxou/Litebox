...
internal static class LightPayload
{
    ...
    public static readonly string[] Files = { "LiteBox.exe", "LiteBox.dll", "LiteBox.deps.json", "LiteBox.runtimeconfig.json", "LibVLCSharp.dll", "ZstdSharp.dll", "Magick.NET-Q16-AnyCPU.dll", "Magick.NET.Core.dll", "Microsoft.ML.OnnxRuntime.dll", "WindowsDisplayAPI.dll", "NvAPIWrapper.dll" };
